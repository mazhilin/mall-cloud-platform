 ...
 */
@DubboProviderServer
public class AppAuthorizeServiceImpl extends BaseServerService implements AppAuthorizeService {
    @Autowired
    ...
    public boolean isLogin(String token) {
        return CheckEmptyUtil.isNotEmpty(token) && CheckEmptyUtil.isNotEmpty(getUserId(token));
    }

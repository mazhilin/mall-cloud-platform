...
/**
 * <p>封装Qicloud项目SmrApplicationAuthorizeHolder类.<br></p>
 * <p>//TODO...<br></p>
 *
 * @author Powered by marklin 2020-11-07 15:28
 * @version 1.0.0
 * <p>Copyright © 2018-2020 Pivotal Cloud Technology Systems Incorporated. All rights reserved.<br></p>
 */
@Component
@Service(interfaceClass = SmrApplicationAuthorize.class)
public class SmrApplicationAuthorizeHolder extends ApplicationAuthorizeHolder implements SmrApplicationAuthorize {
    ...
    public ScopeType getScope() {
        return ScopeType.WECHAT;
    }

    @Override
    public PlatformType getPlatform() {
        return PlatformType.SMR;
    }
}

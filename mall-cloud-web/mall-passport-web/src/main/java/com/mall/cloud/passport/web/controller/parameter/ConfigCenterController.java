package com.mall.cloud.passport.web.controller.parameter;
...
/**
 * <p>封装Qicloud项目ConfigCenterController类.<br></p> 
 * <p>//TODO...<br></p> 
 * @author Powered by marklin 2020-10-27 15:31
 * @version 1.0.0
...
public class ConfigCenterController extends BaseController {
    ...
    public String list(
        ...
        try {
            RequestConfigParam param = new RequestConfigParam();
            param.setName(name);
